            ...
            <div className="alert alert-success mt-2" style={{display: state.successMessage ? 'block' : 'none' }} role="alert">
             ...
             <div className="alert alert-danger mt-2" style={{display: state.errorMessage ? 'block' : 'none' }} role="alert">
                ...
                <form>
                    ...
                    <label htmlFor="exampleInputEmail54">Повне ім'я</label>
                    <input type="text" 
                    ...
                    <div className="form-group text-left">
                    <label htmlFor="exampleInputEmail4">Ім'я користувача</label>
                    <input type="text" 
                        className="form-control" 
                        id="username" 
                    ...
                    <input type="email" 
                        ...
                        id="email" 
                        aria-describedby="emailHelp" 
                        placeholder="Enter адреса" 
                        value={state.email}
                        onChange={handleChange}
                    />
                    <small id="emailHelp" className="form-text text-muted">Ми ніколи нікому не поділимося вашою електронною поштою.</small>
                    </div>
                    <div className="form-group text-left">
                    ...
                    <div className="form-group text-left">
                        <label htmlFor="exampleInputPassword2">Підтвердьте пароль</label>
                        <input type="password" 
                            className="form-control" 
                            id="confirmPassword" 
                ...
                <div className="mt-2">
                    ...
                    <span className="loginText" onClick={() => redirectToLogin()}>Увійдіть тут</span> 
                </div>
