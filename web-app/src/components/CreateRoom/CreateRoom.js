                          ...
                          <Form noValidate onSubmit={handleSubmit}>
                              <Form.Row>
                                  <Form.Group as={Col} md="12" controlId="handle">
                                      <Form.Label>Назва кімнати компанії?</Form.Label>
                                      <Form.Control
                                      type="text"
                                      name="name"
                                      placeholder="Кімната компанії"
                                      value={values.name || ""}
                              ...
                              <Button className="btn btn-secondary" type="submit" style={{ marginRight: "10px" }}>Створити кімнату</Button>
                          </Form>
                          )}
                </Formik>
